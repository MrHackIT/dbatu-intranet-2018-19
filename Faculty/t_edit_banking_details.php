...
include 'isLoggedIn.php';
   ...
   if(! $conn ) {
      ...
      $sql = "SELECT * FROM t_banking_doc WHERE t_emp_id=$temp";
   ...
   if(isset($_POST['t_submit_bank'])){
                // aicte variables
                $t_aicte_bank_name=$_POST['t_bank_name'];
                $t_aicte_branch_name=$_POST['t_branch_name'];
                $t_aicte_ifsc_code=$_POST['t_branch_ifsc'];
                $t_aicte_bank_account_no=$_POST['t_acc_no'];
                $t_aicte_aadhar_card=$_POST['t_adhar_no'];
                $t_aicte_pan_card=$_POST['t_pan_card'];
                ...
                $query3=mysqli_query($conn,"UPDATE t_banking_doc SET t_bank_name='$t_bank_name',
                                                                     t_acc_no='$t_acc_no',
                                                                     t_branch_ifsc='$t_branch_ifsc',
                                                                     t_branch_name='$t_branch_name',
                                                                     t_adhar_no='$t_adhar_no',
                                                                     t_pan_card_no='$t_pan_card_no',
                                                                     t_voter_id_no='$t_voter_id_no' WHERE t_emp_id='$temp'");

                $aicte_query = mysqli_query($conn,"UPDATE t_aicte_details SET t_aicte_bank_name='$t_aicte_bank_name',
                                                                              t_aicte_branch_name='$t_aicte_branch_name',
                                                                              t_aicte_ifsc_code='$t_aicte_ifsc_code',
                                                                              t_aicte_bank_account_no='$t_aicte_bank_account_no',
                                                                              t_aicte_aadhar_card='$t_aicte_aadhar_card',
                                                                              t_aicte_pan_card='$t_aicte_pan_card' WHERE t_emp_id='$temp'");
if($query3 && $aicte_query)
{
...
<div class="container">
	...
	<div class="panel-group">
      ...
      <div class="panel-heading"><h1 class="panel-title" style="color:black">Banking Information and Documents </h1></div>
