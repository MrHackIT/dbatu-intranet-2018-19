  ...
  <body>
                            ...
                            if(isset($_POST["submitbtn"]))
    {
        ...
        { //here you need to add else condition
           $sql = "INSERT INTO login (roll_no, email, password, role) VALUES ('$username', '$email', '$psw', 'stu');";
            $sql .= "INSERT INTO personal_details (roll_no) VALUES ('$username');";
            $sql .= "INSERT INTO info_doc (roll_no) VALUES ('$username');";
            $sql .= "INSERT INTO bank_info_doc (roll_no) VALUES ('$username')";
