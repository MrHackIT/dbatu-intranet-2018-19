...
//echo "$temp";
   ...
   $t_score_10=0;
      $sql = "SELECT * FROM  ntsedu_details WHERE t_emp_id=$temp";
//<<<<<<< HEAD
 ...
 if(isset($_POST['submit_edu']))
        {
            ...
            $t_passing_12=$_POST['t_pass_tenth'];
            $t_passing_university_12=$_POST['t_board_twelve'];
            
            $t_btech_marks=$_POST['t_btech'];
            $t_passing_btech=$_POST['t_pass_btech'];
            $t_passing_university_btech=$_POST['btech_university'];
            
     
            $t_mtech_marks=$_POST['t_mtech'];
            $t_passing_mtech=$_POST['t_pass_mtech'];
            $t_passing_university_mtech=$_POST['mtech_university'];
            
            $t_phd_marks=$_POST['t_phd'];
            $t_passing_phd=$_POST['t_pass_phd'];
            $t_passing_university_phd = $_POST['phd_university'];
            
            $t_postphd_marks=$_POST['t_postphd'];
            $t_passing_postphd=$_POST['t_pass_postphd'];
            $t_passing_university_postphd = $_POST['postphd_university'];
      
            $t_other_marks=$_POST['t_other'];
            $t_passing_other=$_POST['t_pass_other'];
            $t_passing_university_other = $_POST['other_university'];
            
            $t_fields_experties = $_POST['t_field_of_expertise'];
            $t_other_activity = $_POST['t_other'];

            $query3="UPDATE ntsedu_details SET t_score_10='$t_score_10',t_passing_10='$t_passing_10',t_passing_university_10='$t_passing_university_10',t_score_12='$t_score_12',t_passing_12='$t_passing_12',
      t_passing_university_12='$t_passing_university_12',t_btech_marks='$t_btech_marks',t_passing_btech='$t_passing_btech',t_passing_university_btech='$t_passing_university_btech',t_mtech_marks='$t_mtech_marks',t_passing_mtech='$t_passing_mtech',t_passing_university_mtech='$t_passing_university_mtech',t_phd_marks='$t_phd_marks',t_passing_phd='$t_passing_phd',t_passing_university_phd='$t_passing_university_phd',t_postphd_marks='$t_postphd_marks',t_passing_postphd='$t_passing_postphd',t_passing_university_other='$t_passing_university_other' t_passing_university_postphd='$t_passing_university_postphd', t_other_marks='$t_other_marks', t_passing_other='$t_passing_other', t_fields_experties=',$t_fields_experties',t_other_activity='$t_other_activity' WHERE t_emp_id='$temp'";
...
<style>
   ...
   <div class="row row-content">
           ...
           <li class="active"><a href="ntsedintspersonal_details.php">Personal Details</a></li>    
            ...
            <!--li><a href="t_edit_personal_details.php">Personal Details</a></li>    
            <li class="active"><a href="t_edintsedu_details.php">Educational Details</a></li>    
            <li><a href="t_edit_bank_details.php">Account Details</a></li>    
    ...
    <div class="panel-body" style="font-size:100%">
          <!--div class="form-group">
                        <div class="col-sm-3">
                          <label class="control-label"><h3>Exams</h3></label>
                                </div>
                        <div class="col-sm-3">
                          <label class="control-label"><h3>CGPA/Percent</h3></label>
                                </div>
                                <div class="col-sm-3">
                           <label class="control-label"><h3>Passing Year</h3></label>
                                </div>
                                <div class="col-sm-3">
                          <label class="control-label"><h3>State Board</h3></label>
                                </div>
                      </div>
               ...
               <div class="col-sm-12">
                     <div class="form-group"-->
                        ...
                        <input type="text" placeholder="10th Percentage" value="<?php echo $row['t_score_10']?>" class="form-control" id="t_tenth" name="t_tenth" >
                                ...
                                <div class="col-sm-3">
                          <div class="form-group">
                                            <select name="t_board_tenth" class="form-control" id="t_10board" name="t_board_tenth" >
                        ...
                        <label class="control-label"><h4>12<sup>th</sup>/ Diploma</h4><p style="padding:9px"></p></label>
                          ...
                          <input type="text" placeholder="12th Percentage" value="<?php echo $row['t_score_12']?>" class="form-control" id="t_twelth" name="t_twelth">
                           ...
                           <input type="text" class="form-control" value="<?php echo $row['t_passing_12']?>"  placeholder="12th Passing Year" id="t_pass_12" name="t_pass_twelth" >
                                ...
                                <div class="col-sm-3 ">
                          <div class="form-group">
                                                    <select name="t_board_twelve" class="form-control" id="t_12board" name="t_twelth">
                                                    <option value="" >------------Select State------------</option>
          ...
          <div class="col-sm-12">
                     <div class="form-group">
                                <div class="col-sm-3">
                        <label class="control-label"><h4>B.Tech/B.E</h4><p style="padding:9px"></p></label>
                                </div>
                                <div class="col-sm-3">
                        <input type="text" placeholder="B.Tech  C.G.P.A." value="<?php echo $row['t_btech_marks']?>"  class="form-control" id="t_btech" name="t_btech" >
                                </div>
                                <div class="col-sm-3">
                           <input type="text" class="form-control"  value="<?php echo $row['t_passing_btech']?>" placeholder="B.Tech Passing Year" id="t_pass_btech" name="t_pass_btech" >
                                </div>
                                <div class="col-sm-3">
                          <input type="text" placeholder="B.Tech University" value="<?php echo $row['t_passing_university_btech']?>" class="form-control" name="btech_university" >
                                </div>
                      </div>
          </div>
          <div class="col-sm-12">
                     <div class="form-group">
                                <div class="col-sm-3">
                        <label class="control-label"><h4>M.Tech/M.E</h4><p style="padding:9px"></p></label>
                                </div>
                                <div class="col-sm-3">
                        <input type="text" placeholder="M.Tech  C.G.P.A."  value="<?php echo $row['t_mtech_marks']?>" class="form-control" id="t_mtech" name="t_mtech">
                                </div>
                                <div class="col-sm-3">
                           <input type="text" class="form-control" value="<?php echo $row['t_passing_mtech']?>" placeholder="M.Tech Passing Year" id="t_pass_mtech" name="t_pass_mtech">
                                </div>
                                <div class="col-sm-3">
                          <input type="text" placeholder="M.Tech University"  value="<?php echo $row['t_passing_university_mtech']?>" class="form-control" name="mtech_university">
                                </div>
                      </div>
          </div>
          <div class="col-sm-12">
                     <div class="form-group">
                        ...
                        <input type="text" placeholder="Grading Scale"  value="<?php echo $row['t_phd_marks']?>" class="form-control" id="t_phd" name="t_phd"  >
                           ...
                           <input type="text"  class="form-control"  value="<?php echo $row['t_passing_phd']?>" placeholder="PhD Passing Year" id="t_pass_phd" name="t_pass_phd">
                                ...
                                <div class="col-sm-3">
                          <input type="text" placeholder="PhD University"  value="<?php echo $row['t_passing_university_phd']?>" class="form-control" name="phd_univerisity" >
                                </div>
                    </div>
          </div>
          <div class="col-sm-12">
                     <div class="form-group">
                        ...
                        <label class="control-label"><h4>Post Doctoral Fellowship</h4><p style="padding:9px"></p></label>
                                ...
                                <div class="col-sm-3">
                        <input type="text" placeholder="Grading Scale"  value="<?php echo $row['t_postphd_marks']?>" class="form-control" id="t_postphd" name="t_postphd">
                                </div>
                                <div class="col-sm-3">
                           <input type="text" class="form-control" value="<?php echo $row['t_passing_postphd']?>" placeholder="Receiving Year" id="t_pass_postphd" name="t_pass_postphd">
                                </div>
                                <div class="col-sm-3">
                          <input type="text" placeholder="University"  value="<?php echo $row['t_passing_university_postphd']?>" class="form-control" name="postphd_university">
                                </div>
                      </div>
          </div> 
           <div class="col-sm-12">
                     <div class="form-group">
                        ...
                        <label class="control-label"><h4>Others</h4><p style="padding:9px"></p></label>
                                ...
                                <div class="col-sm-3">
                        <input type="text" placeholder="Grading Scale"  value="<?php echo $row['t_other_marks']?>" class="form-control" id="t_other" name="t_other">
                                </div>
                                <div class="col-sm-3">
                           <input type="text" class="form-control" value="<?php echo $row['t_passing_other']?>" placeholder="Receiving Year" id="t_pass_other" name="t_pass_other">
                                </div>
                                <div class="col-sm-3">
                          <input type="text" placeholder="University"  value="<?php echo $row['t_passing_university_other']?>" class="form-control" name="other_university">
                                </div>
                      </div>
          </div>
