...
--
-- Table structure for table `ntsbanking_doc`
--

CREATE TABLE `ntsbanking_doc` (
...
--
-- Dumping data for table `ntsbanking_doc`
--

INSERT INTO `ntsbanking_doc` (`t_id`, `t_emp_id`, `t_discipline`, `t_bank_name`, `t_acc_no`, `t_branch_ifsc`, `t_branch_name`, `t_adhar_no`, `t_pan_card_no`, `t_voter_id_no`, `t_gen_income_certi`, `t_gen_domi_certi`, `t_oth_income_certi`, `t_oth_domi_certi`, `t_oth_caste_certi`, `t_oth_caste_vali`, `t_oth_non_creamy`, `t_gen_income_name`, `t_gen_domi_name`, `t_other_income_name`, `t_oth_domi_name`, `t_oth_cast_name`, `t_oth_vali_name`, `t_gen_non_name`) VALUES
(1, '', '', 'Andhra Bank', '213', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
...
--
-- Indexes for table `ntsbanking_doc`
--
ALTER TABLE `ntsbanking_doc`
...
--
-- AUTO_INCREMENT for table `ntsbanking_doc`
--
ALTER TABLE `ntsbanking_doc`
